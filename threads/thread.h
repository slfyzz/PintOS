...
void update_priority_mlfqs (struct thread* cur, void* aux UNUSED);
void update_recent_cpu_mlfqs (struct thread* cur, void* aux UNUSED);
void update_load_avg_mlfqs (void);
